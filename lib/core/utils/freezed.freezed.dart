...
class _$_RegisterObject implements _RegisterObject {
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, email: $email, password: $password, confirmPassword: $confirmPassword)';
  }
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(final String userName, final String email,
      final String password, final String confirmPassword) = _$_RegisterObject;
